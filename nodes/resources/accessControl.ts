...
export const accessControlProperties: INodeProperties[] = [
	// ─── Role: Operation ──────────────────────────────────────────────────────
	{
		...
		options: [
			...
			{ name: 'Get by IDs', value: 'getByIds', action: 'Get roles by i ds', description: 'Get role details by role IDs' },
	...
	// ─── Organisation: Operation ──────────────────────────────────────────────
	{
		...
		options: [
			...
			{ name: 'Get Many', value: 'getAll', action: 'Get many organisations', description: 'List many organisations the current user belongs to' },

...
export const tagProperties: INodeProperties[] = [
	...
	// ─── Tag Names or IDs (addTag / removeTag) ────────────────────────────────
	{
		...
		description: 'Tags to add or remove. Choose from the list, or specify names using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	},
